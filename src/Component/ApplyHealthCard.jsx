...
import Navbar from "./Navbar";
import ScrollingTagline from "./ScrollingTagline";
import Aarogyadhan_slider from "./Aarogyadhan_slider";
// import bgimage from '../assets/Images/5.jpg';
import Aarogy_Aadhar01 from '../assets/Images/NewSilder/Aarogy Aadhar01.jpg';
...
const ApplyHealthCard = () => {
  return (
    <>
      ...
      <div className="mt-[135px] xl:mt-[145px] pt-3 py-3 bg-blue-500">
        <div className="grid md:grid-cols-12 gap-3 py-4 px-3">
          <div className="hidden md:block col-span-12 md:col-span-4 w-full pt- lg:flex flex-col justify-center items-center">
            <img src={Aarogy_Aadhar01} alt="Apply Health Card" />
          </div>
          <div className="col-span-12 md:col-span-8 ">
            <h2 className="text-4xl font-bold text-center mx-2 py-2 text-white justify-self-end">
              Aarogya Aadhar Member Registration
            </h2>
            <hr className="my-4 mx-4" />
            <div className="col-span-12 md:col-span-8">
            ...
            Aarogya Aadhar Member Registration Details:
                ...
                <div className="flex flex-col">
                  ...
                  <div className="relative max-w-[70%]">
                    <select
                      name=""
                      id=""
                      className="border border-blue-500 h-10  text-gray-400 outline-none rounded-md pr-10 pl-3 appearance-none  w-full"
                    >
                      <option value="">Select Gender</option>
                      <option value="">Male</option>
                      <option value="">Female</option>
              ...
              <div className="flex justify-end px-20">
                <button className="rounded-md text-white bg-blue-900 px-4 py-2">
                  Submit
                </button>
              </div>
            </div>
