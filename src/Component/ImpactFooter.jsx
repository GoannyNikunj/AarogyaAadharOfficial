    ...
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 xl:flex xl:justify-between py-2 pt-5 px-4 lg:px-16">
        <div className="flex flex-col">
          <h3 className=" text-md  sm:text-2xl lg:text-xl xl:text-2xl font-bold pb-2 text-blue-900">
            About Us
          </h3>
          <p className="cursor-pointer text-[10px] sm:text-[13px] xl:text-[16px] text-blue-900">
            Team
          </p>
          <p className="cursor-pointer text-[10px] sm:text-[13px] xl:text-[16px] text-blue-900 py-2">
            Careers
          </p>
          <p className="cursor-pointer text-[10px] sm:text-[13px] xl:text-[16px] text-blue-900">
            Blog
        ...
        <div>
          ...
          <p className=" text-[10px] sm:text-[13px] xl:text-[16px] text-blue-900">
            Social Links
          </p>
          ...
          <p className=" mt-1 cursor-pointer text-[10px] sm:text-[13px] xl:text-[16px] text-blue-900">
            Click below to Raise a Concern
          </p>
          <button className=" bg-blue-500 text-white mt-2 text-[13px] py-1 px-3 rounded-md">
            Raise A Concern
          </button>
          <div></div>
        </div>
        ...
        <div className="hidden lg:flex flex-col">
          <h1 className="text-md  sm:text-2xl lg:text-xl xl:text-2xl font-bold pb-2 text-blue-900">
            Download App
          </h1>
      ...
      <div className=" mt-5 mx-3 lg:mx-14">
        <div className=" flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4 ">
          <img
            ...
            alt=""
            className="h-16 w-40 md:h-16 md:w-40"
          />
          <p className=" text-[10px] sm:text-[13px] xl:text-[16px] text-blue-900">
            Aarogya Aadhar is an online technology platform connecting donors
            and donees. We do not provide any financial return in any form
            whatsoever, including but not limited to financial securities (debt
            or equity), interest, dividend, profit share, rewards in cash, to
            individuals who make payments on the Platform.
          </p>
        </div>
