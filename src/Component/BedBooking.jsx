...
const BedBooking = () => {
  ...
  return (
    <div>
      ...
      <div className="mt-[135px] xl:mt-36 pt-4 py-3 bg-blue-500">
        <div className="grid grid-cols-12 gap-4 px-3">
          <div className="col-span-12 md:col-span-8 md:col-start-4 xl:col-start-4">
        <h2 className="text-4xl font-bold className=text-center text-white text-center">
          Bed Booking
        </h2>
        </div>
        </div>
          ...
          <div className="col-span-12 md:col-span-8 mt-12">
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  <div className="relative max-w-[85%]">
                    <select
                      id="hospital-type"
                      className="border border-blue-500  text-gray-400  h-10 outline-none rounded-xl pr-10 pl-3 appearance-none  w-full"
                      required
                      onFocus={handleHospitalTypeFocus}
                      onBlur={handleHospitalTypeBlur}
                      ref={hospitalTypeRef}
                ...
                <div className="flex flex-col">
                  ...
                  <div className="relative max-w-[85%]">
                    <select
                      id="hospital-bed"
                      className="border border-blue-500 h-10  text-gray-400 outline-none rounded-xl pr-10 pl-3 appearance-none  w-full"
                      required
                      onFocus={handleHospitalBedFocus}
                      onBlur={handleHospitalBedBlur}
                      ref={hospitalBedRef}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    onChange={(e) => setHospitalName(e.target.value)}
                    placeholder="Enter Hospital Name"
                    className="border border-blue-500 h-10  outline-none rounded-xl px-3 max-w-[85%]"
                    required
                  />
                  {hospitalNameError && (
                    <span className="text-red-500 text-sm">
              ...
              <div className="flex justify-end mt-5 px-20">
                <button
                  type="submit"
                  className="text-white bg-blue-900 px-3 py-2 rounded-xl"
                >
                  Book your Bed
                </button>
              </div>
